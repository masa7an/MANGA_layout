...
入るレイヤーは次の8種類で、**置いていないものは入りません**（フキダシを使っていない
ページに、空の「フキダシ」は出てきません）。
...
- **コマ同士が重なっているページでは、重なり方が PNG と少し変わります。**
  枠線がまとめて絵の上に乗ります。普通のコマ割り（重ねていない）では起きません
