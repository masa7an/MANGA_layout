...
**セリフを傾けたいときは「画像にする」。** セリフのメニューか右クリックから選ぶと、
そのセリフが**1枚の画像**（透明な背景に字が乗っただけのもの）になります。画像になると
...
- **字が1つも入っていないセリフは画像にできません**（項目が押せません）
...
セリフを選んでいれば そのセリフの書体が、選んでいなければ**次に作るセリフ**の書体が変わります。
